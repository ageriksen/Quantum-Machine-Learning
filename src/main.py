...
"""
The main aim of QML lies in using the polynomial approximation to the exponentially larger
dimension of data for a set of qubits to a set of bits. This is typically achieved by an 
encoding of the data into a rotation along a high-dimensional quantum state. The aim of 
this project is to explore the first 2 targets of the iris dataset from scikit learn. 
"""
data = load_iris()
##print(data)
#
